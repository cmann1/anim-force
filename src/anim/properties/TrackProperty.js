...
(function (app) {
    ...
    (function (anim) {
        ...
        (function (properties) {
            ...
            })(TrackPropertyType = properties.TrackPropertyType || (properties.TrackPropertyType = {}));
            var TrackProperty = (function () {
                ...
                TrackProperty.create = function (track, propertyName, type) {
                    if (type == TrackPropertyType.NUMBER) {
                        return new properties.NumberProperty(track, propertyName);
                    }
                    if (type == TrackPropertyType.ANGLE) {
                        return new properties.AngleProperty(track, propertyName);
                    }
                    if (type == TrackPropertyType.VECTOR) {
                        return new properties.VectorProperty(track, propertyName);
                    }
            ...
            properties.TrackProperty = TrackProperty;
