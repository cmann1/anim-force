namespace app.assets
{
	...
	{
		private static SPRITE_LOADING_IMG:HTMLCanvasElement;
		private static SPRITE_ERROR_IMG:HTMLCanvasElement;
		private static NULL_FRAME_DATA:SpriteFrame[][];
		private static _NULL:SpriteAsset;

		public path:String;
		public sheet:HTMLCanvasElement;
		...
		static init()
		{
			SpriteAsset.SPRITE_LOADING_IMG = <HTMLCanvasElement> document.createElement('canvas');
			SpriteAsset.SPRITE_ERROR_IMG = <HTMLCanvasElement> document.createElement('canvas');
