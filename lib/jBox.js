  ...
  var jBox = function jBox(type, options) {
    ...
    this._isolateScroll = function (el)
    {
      ...
      el.on('DOMMouseScroll.jBoxIsolateScroll mousewheel.jBoxIsolateScroll', function (ev) {
        ...
        console.log('YOYO', ((delta < 0 && overflowBottom) || (delta > 0 && overflowTop)));
    ...
    this._attachEvents = function ()
    {
      ...
      if (this.options.closeOnClick === true || this.options.closeOnClick == 'body') {
        jQuery(document).on('touchend.jBox-' + this.id + ' click.jBox-' + this.id + ' contextmenu.jBox-' + this.id, function (ev) {
    ...
    this._detachEvents = function ()
    {
      ...
      // Closing event: closeOnClick
      if(this.options.closeOnClick === true || this.options.closeOnClick == 'body') {
        jQuery(document).off('touchend.jBox-' + this.id + ' click.jBox-' + this.id + ' mousedown.jBox-' + this.id + ' contextmenu.jBox-' + this.id);
      }
