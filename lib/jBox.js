  ...
  var jBox = function jBox(type, options) {
    ...
    this._attachEvents = function ()
    {
      ...
      if (this.options.closeOnClick === true || this.options.closeOnClick == 'body') {
        jQuery(window).on('touchend.jBox-' + this.id + ' click.jBox-' + this.id + ' mousedown.jBox-' + this.id + ' contextmenu.jBox-' + this.id, function (ev) {
    ...
    this._detachEvents = function ()
    {
      ...
      // Closing event: closeOnClick
      (this.options.closeOnClick === true || this.options.closeOnClick == 'body') && jQuery(document).off('touchend.jBox-' + this.id + ' click.jBox-' + this.id + ' mousedown.jBox-' + this.id + ' contextmenu.jBox-' + this.id);
